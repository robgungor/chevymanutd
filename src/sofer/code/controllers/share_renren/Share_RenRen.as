package code.controllers.share_renren
{
	 ...
	 * @author Me^
	 */
	public class Share_RenRen
	{
		private var btn_open			:InteractiveObject;
		private var ui					:ShareRenRenUI;
		/*
		* 
		* 
		* 
		...
		***************************** INIT */
		 ...
		 * Constructor
		 */
		public function Share_RenRen( _btn_open:InteractiveObject, _ui:ShareRenRenUI ) 
		{
		...
		{	
			...
			//App.listener_manager.add( ui.btn_post, MouseEvent.CLICK, mouse_click_handler, this );
			close_win();
		}
		/************************************************
		* 
		...
		***************************** INTERNALS */
		private function mouse_click_handler( _e:MouseEvent ):void
		{
			...
			{	
				...
				case  ui.btn_post:					
					...
					break;
				case  ui.btn_profile:					
					App.mediator.renrenPostProfileImage();
					break;
				case  ui.btn_close:					
					close_win();
					break;
		...
		private function open_win():void
		{
			...
			//ui.visible = true;
			App.mediator.renren_connect_login(_onLogin);
		}
