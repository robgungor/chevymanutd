package code.controllers.share_digg 
{
	...
	public class Share_Digg
	{
		...
		***************************** INIT */
		 ...
		 * Constructor
		 */
		public function Share_Digg( _btn_open:InteractiveObject ) 
		{
			...
			function share_to_destination(  ):void
			{
				...
				function open_link( _ok:Boolean ):void
				{
					if (_ok)
					{
						...
						var workshop_description:String = App.settings.DIGG_SHARE_DESC;	// "This is the flash 9 3d template";
						url = "http://digg.com/submit?url=" + escape(workshop_url) + "&title=" + escape(workshop_name) + "&bodytext=" + escape(workshop_description)+"&media=MEDIA&topic="+workshop_topic;
						ExternalInterface_Proxy.call("window.open", url, "digg");
