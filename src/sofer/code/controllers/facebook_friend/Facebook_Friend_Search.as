	...
	public class Facebook_Friend_Search implements IFacebook_Friend_Search
	{
        ...
        { 
			App.listener_manager.add_multiple_by_object([	//btn_open,
															//App.ws_art.mainPlayer.facebook_btn,							
															ui.btn_close,
															ui.tf_filter, 
															ui.btn_all,
															ui.btn_none, 
		...
		private function click_event_handler( _e:MouseEvent ):void
		{
			...
			{	
				...
				case App.ws_art.mainPlayer.facebook_btn: WSEventTracker.event("ce9"); optInConfirm(); break; //App.mediator.checkOptIn(optInConfirm);	break;
        ...
        public function open_win( _callback:Function, isAutoPhoto:Boolean = false ) : void
        {
			...
			//App.mediator.facebook_connect_checkLoginState(retrieve_friends_list);
			set_focus();
