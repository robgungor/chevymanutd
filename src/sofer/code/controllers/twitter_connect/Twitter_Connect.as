		...
		public function post_profile_image( ):void
		{
			...
			function user_is_logged_in():void 
			{
				...
				function fin_message_saved():void
				{
					...
					App.mediator.alert_user( new AlertEvent(AlertEvent.TWITTER_CONFIRM, 'f9t542', App.localizer.getTranslation('twitter_share_pop_up_subtitle'), false, user_response, false) );
