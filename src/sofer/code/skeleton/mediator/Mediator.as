...
//		}
		...
		* ************************************* AUTO PHOTO */
		...
		public function logoutAndRestart():void
		{
		...
		{
			if(controller_pool.preview)
			{	
				controller_pool.preview.open_win();
			}
		}
		...
		public function autophoto_get_apc_display():DisplayObject
		{	
			if (controller_pool.auto_photo_apc)	
